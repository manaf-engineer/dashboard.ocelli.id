...
declare global {
  ...
  const $checkAccess: typeof import('./src/utils/api')['$checkAccess']
  const $emitter: typeof import('./src/utils/emitter')['$emitter']
  const $errorApi: typeof import('./src/utils/api')['$errorApi']
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly $checkAccess: UnwrapRef<typeof import('./src/utils/api')['$checkAccess']>
    readonly $emitter: UnwrapRef<typeof import('./src/utils/emitter')['$emitter']>
    readonly $errorApi: UnwrapRef<typeof import('./src/utils/api')['$errorApi']>
    readonly $logout: UnwrapRef<typeof import('./src/utils/api')['$logout']>
